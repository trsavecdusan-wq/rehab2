...
object AacStarterContentV1 {
    fun items(): List<AacItem> = listOf(
        ...
        starter("drink", "PIJAČA", "Kaj bi pila?", "drink.root", "DRINK", "drink", listOf("pijača", "piti"), placements = pageOne(21), opensSubicons = true, children = listOf("water", "tea", "coffee", "drink_fanta", "drink_coca_cola", "drink_pepsi", "juice", "drink_milk", "drink_warm", "drink_cold", "drink_small", "drink_more"), questionByLanguage = mapOf("sl" to "Kaj bi pila?", "uk" to "Що ти хочеш пити?", "en" to "What do you want to drink?")),
        starter("food", "HRANA", "Kaj želiš jesti?", "food.root", "FOOD", "food", listOf("hrana", "jesti"), placements = pageOne(22), opensSubicons = true, children = listOf("bread", "soup", "food_yogurt", "food_banana", "food_apple", "food_lunch", "food_dinner", "fruit", "sweet", "not_hungry", "food_more", "food_enough"), questionByLanguage = mapOf("sl" to "Kaj želiš jesti?", "uk" to "Що ти хочеш їсти?", "en" to "What do you want to eat?")),
        starter("feeling", "POČUTJE", "Kako se počutiš?", "feeling.root", "FEELING", "feeling", listOf("počutje"), placements = pageOne(23), opensSubicons = true, children = listOf("good", "bad", "tired", "afraid", "sad", "happy", "cold", "hot", "peace", "rest"), questionByLanguage = mapOf("sl" to "Kako se počutiš?", "uk" to "Як ти почуваєшся?", "en" to "How do you feel?")),
        starter("care", "NEGA", "Kaj potrebuješ?", "care.root", "NEED", "care", listOf("nega", "pomoč"), placements = pageOne(24), opensSubicons = true, children = listOf("wc", "washing_help", "dressing_help", "bed", "wheelchair", "crutch", "body_position", "movement_pain", "wait", "help"), questionByLanguage = mapOf("sl" to "Kaj potrebuješ?", "uk" to "Що тобі потрібно?", "en" to "What do you need?")),
        starter("health", "ZDRAVJE", "Kaj je z zdravjem?", "health.root", "NEED", "health", listOf("zdravje"), placements = pageOne(25), opensSubicons = true, children = listOf("pain", "head", "arm", "leg", "belly", "back", "throat", "medicine", "therapy", "doctor"), questionByLanguage = mapOf("sl" to "Kaj je z zdravjem?", "uk" to "Що зі здоров'ям?", "en" to "What is wrong with health?")),
