...
object AacStarterContentV1 {
    fun items(): List<AacItem> = listOf(
        ...
        starter("help", "POMOČ", "Prosim, pomagajte mi.", "core.help", "NEED", "core", listOf("pomoč", "nujno"), visibleUnderIds = listOf("need", "please", "care")),
        starter("wait", "POČAKAJ", "Počakajte, prosim.", "core.wait", "CORE_ACTION", "core", listOf("počakaj", "čas"), placements = pageOne(21)),
        starter("repeat", "PONOVI", "Prosim, ponovite.", "core.repeat", "CORE_ACTION", "core", listOf("ponovi", "razumevanje"), placements = pageOne(20)),
        ...
        starter("people", "LJUDJE", "Ljudje.", "people.root", "PEOPLE", "people", listOf("ljudje", "osebe"), placements = pageOne(1)),
        starter("need", "POTREBUJEM", "Potrebujem pomoč.", "need.root", "NEED", "need", listOf("potrebujem", "pomoč"), placements = pageOne(2)),
        starter("problem", "TEŽAVA", "Imam težavo.", "problem.root", "NEED", "problem", listOf("težava", "problem"), placements = pageOne(3)),

        starter("family_group", "DRUŽINA", "Družina.", "people.family_group", "PEOPLE", "people", listOf("družina", "ljudje"), visibleUnderIds = listOf("people"), opensSubicons = true, children = listOf("person_dusan", "person_zana", "person_sergej", "person_julija", "person_oksana", "person_inna", "person_franc", "miss_you", "love_you", "contact_call"), questionByLanguage = mapOf("sl" to "Koga iz družine?", "uk" to "Кого з родини?", "en" to "Which family member?")),
        ...
        starter("call", "POKLIČI", "Prosim, pokličite nekoga.", "people.call", "CORE_ACTION", "people", listOf("pokliči", "telefon"), visibleUnderIds = listOf("people", "need"), opensSubicons = true, children = listOf("person_dusan", "person_zana", "person_sergej", "person_julija", "person_oksana", "person_inna", "person_franc", "doctor", "nurse"), questionByLanguage = mapOf("sl" to "Koga naj pokličem?", "uk" to "Кому подзвонити?", "en" to "Who should I call?")),
        starter("message", "SPOROČILO", "Pošljite sporočilo.", "people.message", "CORE_ACTION", "people", listOf("sporočilo"), visibleUnderIds = listOf("people")),
        starter("miss_someone", "POGREŠAM", "Pogrešam vas.", "people.miss_someone", "PEOPLE", "people", listOf("pogrešam", "ljudje"), visibleUnderIds = listOf("people")),

        starter("thirsty", "ŽEJNA SEM", "Žejna sem.", "drink.thirsty", "DRINK", "drink", listOf("žejna", "piti"), placements = pageOne(4), opensSubicons = true, children = listOf("water", "tea", "coffee", "drink_fanta", "drink_coca_cola", "drink_pepsi", "juice", "drink_milk", "drink_warm", "drink_cold", "drink_small", "drink_more"), questionByLanguage = mapOf("sl" to "Kaj bi pila?", "uk" to "Що ти хочеш пити?", "en" to "What do you want to drink?")),
        starter("hungry", "LAČNA SEM", "Lačna sem.", "food.hungry", "FOOD", "food", listOf("lačna", "jesti"), placements = pageOne(5), opensSubicons = true, children = listOf("bread", "soup", "food_yogurt", "food_banana", "food_apple", "food_lunch", "food_dinner", "fruit", "sweet", "not_hungry", "food_more", "food_enough"), questionByLanguage = mapOf("sl" to "Kaj želiš jesti?", "uk" to "Що ти хочеш їсти?", "en" to "What do you want to eat?")),
        starter("wc", "WC", "Moram na WC.", "care.wc", "NEED", "care", listOf("wc", "stranišče"), placements = pageOne(7)),
        starter("tired", "UTRUJENA", "Utrujena sem.", "feeling.tired", "FEELING", "feeling", listOf("utrujena", "počutje"), placements = pageOne(8), visibleUnderIds = listOf("feeling")),

        starter("what_root", "KAJ?", "Kaj?", "question.what", "QUESTION", "question", listOf("kaj", "vprašanje"), placements = pageOne(11)),
        starter("where_root", "KJE?", "Kje?", "question.where", "QUESTION", "question", listOf("kje", "vprašanje"), placements = pageOne(12)),
        starter("when_root", "KDAJ?", "Kdaj?", "question.when", "QUESTION", "question", listOf("kdaj", "vprašanje"), placements = pageOne(13)),
        starter("home", "DOMOV", "Domov.", "place.home", "PLACE", "place", listOf("domov", "dom"), placements = pageOne(14)),
        starter("other", "DRUGO", "Drugo.", "core.other", "CORE_ACTION", "core", listOf("drugo"), placements = pageOne(15)),
        starter("real_world", "REAL WORLD", "Real world.", "scenario.real_world", "SCENARIO", "scenario", listOf("real_world", "scenarij"), placements = pageOne(16)),
        ...
        starter("rest", "POČITEK", "Rada bi počivala.", "care.rest", "NEED", "care", listOf("počitek", "utrujena"), placements = pageOne(9)),
        starter("drink", "PIJAČA", "Kaj bi pila?", "drink.root", "DRINK", "drink", listOf("pijača", "piti"), visibleUnderIds = listOf("thirsty"), opensSubicons = true, children = listOf("water", "tea", "coffee", "drink_fanta", "drink_coca_cola", "drink_pepsi", "juice", "drink_milk", "drink_warm", "drink_cold", "drink_small", "drink_more"), questionByLanguage = mapOf("sl" to "Kaj bi pila?", "uk" to "Що ти хочеш пити?", "en" to "What do you want to drink?")),
        starter("food", "HRANA", "Kaj želiš jesti?", "food.root", "FOOD", "food", listOf("hrana", "jesti"), visibleUnderIds = listOf("hungry"), opensSubicons = true, children = listOf("bread", "soup", "food_yogurt", "food_banana", "food_apple", "food_lunch", "food_dinner", "fruit", "sweet", "not_hungry", "food_more", "food_enough"), questionByLanguage = mapOf("sl" to "Kaj želiš jesti?", "uk" to "Що ти хочеш їсти?", "en" to "What do you want to eat?")),
        ...
        starter("please", "PROSIM", "Prosim.", "core.please", "CORE_ACTION", "core", listOf("prosim"), placements = pageOne(10) + pageTwo(16)),
        starter("call_me", "POKLIČI ME", "Prosim, pokliči me.", "people.call_me", "CORE_ACTION", "people", listOf("pokliči_me"), placements = pageTwo(17)),
        starter("come_to_me", "PRIDI K MENI", "Prosim, pridi k meni.", "people.come_to_me", "CORE_ACTION", "people", listOf("pridi", "k_meni"), placements = pageOne(22) + pageTwo(19)),
        starter("cannot", "NE MOREM", "Ne morem.", "core.cannot", "CORE_ACTION", "core", listOf("ne_morem", "zmorem"), placements = pageOne(23)),
        starter("cold_hot", "MRAZ/VROČE", "Mraz ali vroče.", "feeling.temperature", "FEELING", "feeling", listOf("mraz", "vroče", "temperatura"), placements = pageOne(24)),
        ...
        starter("person_dusan", "DUŠAN", "Dušan.", "person.dusan", "PEOPLE", "people", listOf("dušan", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/dusan.jpg", iconSource = IconSource.PATIENT),
        starter("person_zana", "ŽANA", "Žana.", "person.zana", "PEOPLE", "people", listOf("žana", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/zana.jpg", iconSource = IconSource.PATIENT),
        starter("person_sergej", "SERGEJ", "Sergej.", "person.sergej", "PEOPLE", "people", listOf("sergej", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/sergej.jpg", iconSource = IconSource.PATIENT),
        starter("person_julija", "JULIJA", "Julija.", "person.julija", "PEOPLE", "people", listOf("julija", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/julija.jpg", iconSource = IconSource.PATIENT),
        starter("person_oksana", "OKSANA", "Oksana.", "person.oksana", "PEOPLE", "people", listOf("oksana", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/oksana.jpg", iconSource = IconSource.PATIENT),
        starter("person_inna", "INNA", "Inna.", "person.inna", "PEOPLE", "people", listOf("inna", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/inna.jpg", iconSource = IconSource.PATIENT),
        starter("person_franc", "FRANC", "Franc.", "person.franc", "PEOPLE", "people", listOf("franc", "družina"), visibleUnderIds = listOf("family_group", "call"), imagePath = "patient/contacts/franc.jpg", iconSource = IconSource.PATIENT),
        ...
        starter("water", "VODA", "Rada bi vodo.", "drink.water", "DRINK", "drink", listOf("voda", "piti"), placements = pageThree(6), visibleUnderIds = listOf("drink", "thirsty"), imagePath = "custom/drinks/water.jpg", iconSource = IconSource.CUSTOM),
        ...
        starter("drink_fanta", "FANTA", "Rada bi Fanto.", "drink.fanta", "DRINK", "drink", listOf("fanta", "piti"), visibleUnderIds = listOf("drink", "thirsty"), imagePath = "custom/drinks/fanta.jpg", iconSource = IconSource.CUSTOM),
        starter("drink_coca_cola", "COCA COLA", "Rada bi Coca Colo.", "drink.coca_cola", "DRINK", "drink", listOf("coca_cola", "piti"), visibleUnderIds = listOf("drink", "thirsty"), imagePath = "custom/drinks/coca_cola.jpg", iconSource = IconSource.CUSTOM),
        starter("drink_pepsi", "PEPSI", "Rada bi Pepsi.", "drink.pepsi", "DRINK", "drink", listOf("pepsi", "piti"), visibleUnderIds = listOf("drink", "thirsty"), imagePath = "custom/drinks/pepsi.jpg", iconSource = IconSource.CUSTOM),
        starter("drink_milk", "MLEKO", "Rada bi mleko.", "drink.milk", "DRINK", "drink", listOf("mleko", "piti"), visibleUnderIds = listOf("drink", "thirsty"), imagePath = "custom/drinks/milk.jpg", iconSource = IconSource.CUSTOM),
        ...
        starter("food_lunch", "KOSILO", "Rada bi kosilo.", "food.lunch", "FOOD", "food", listOf("kosilo", "jesti"), visibleUnderIds = listOf("food", "hungry")),
        starter("food_dinner", "VEČERJA", "Rada bi večerjo.", "food.dinner", "FOOD", "food", listOf("večerja", "jesti"), visibleUnderIds = listOf("food", "hungry")),
        ...
        starter("uncomfortable", "NEUDOBNO", "Neudobno mi je.", "care.uncomfortable", "FEELING", "care", listOf("neudobno", "udobje"), placements = pageOne(25), visibleUnderIds = listOf("care")),
        ...
        starter("pain", "BOLI ME", "Boli me.", "pain.general", "PAIN", "pain", listOf("bolečina", "boli"), placements = pageOne(6), opensSubicons = true, children = listOf("head", "arm", "leg", "belly", "back", "chest", "throat"), questionByLanguage = mapOf("sl" to "Kje te boli?", "uk" to "Де тебе болить?", "en" to "Where does it hurt?")),
        ...
        starter("cold", "MRAZ MI JE", "Mraz mi je.", "feeling.cold", "FEELING", "feeling", listOf("zebe", "mraz"), visibleUnderIds = listOf("feeling")),
        ...
        starter("therapy", "TERAPIJA", "Kdaj je terapija?", "health.therapy", "QUESTION", "health", listOf("terapija", "zdravje"), visibleUnderIds = listOf("health")),

        starter("wheelchair", "VOZIČEK", "Prosim, pripravite voziček.", "mobility.wheelchair", "NEED", "mobility", listOf("voziček", "premik"), visibleUnderIds = listOf("care")),
        starter("crutch", "BERGLA", "Prosim, pomagajte mi z berglo.", "mobility.crutch", "NEED", "mobility", listOf("bergla", "varnost"), visibleUnderIds = listOf("care")),
    ...
    private val STARTER_IDS = listOf(
        ...
        "person_franc", "friend_1", "friend_2", "friend_3",
        "water", "coffee", "tea", "juice", "drink_fanta", "drink_coca_cola", "drink_pepsi", "drink_milk",
        "drink_warm", "drink_cold", "drink_small", "drink_more",
        "soup", "bread", "fruit", "meat", "sweet", "other_food", "food_yogurt", "food_banana",
        "food_apple", "food_lunch", "food_dinner", "food_more", "food_enough",
        ...
        "bed", "movement_pain",
        "pain_area", "good", "bad", "afraid", "angry", "cold", "hot", "peace",
