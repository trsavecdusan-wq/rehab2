...
object AacStarterContentV1 {
    fun items(): List<AacItem> = listOf(
        ...
        starter("yes", "DA", "Da.", "core.yes", "CONFIRMATION", "core", listOf("da", "potrditev"), fixedTopRowPosition = 3, imagePath = "system/yes.png", iconSource = IconSource.SYSTEM),
        starter("dont_understand", "NE RAZUMEM", "Ne razumem.", "core.dont_understand", "CONFIRMATION", "core", listOf("razumevanje", "ne_razumem"), fixedTopRowPosition = 2, imagePath = "system/dont_understand.png", iconSource = IconSource.SYSTEM),
        ...
        starter("dressing", "OBLAČENJE", "Potrebujem pomoč pri oblačenju.", "care.dressing.topic", "NEED", "care", listOf("oblačenje", "pomoč"), visibleUnderIds = listOf("help"), imagePath = "custom/body/dressing.jpg", iconSource = IconSource.CUSTOM),
        ...
        starter("nurse_help", "MEDICINSKA SESTRA", "Medicinska sestra.", "wc.nurse_help", "HELPER", "wc", listOf("medicinska_sestra", "pomoč", "wc"), visibleUnderIds = listOf("wc"), opensSubicons = true, children = listOf("help_dressing", "help_washing", "help_showering", "noticed_blood"), labelByLanguage = mapOf("uk" to "СЕСТРА"), speechTextByLanguage = mapOf("uk" to "Медична сестра."), imagePath = "custom/care/nurse.jpg", iconSource = IconSource.CUSTOM),
        ...
        starter("wc_blood", "KRI", "Vidim kri.", "wc.problem.blood", "PROBLEM", "wc", listOf("kri", "wc"), imagePath = "arasaac/wc/kri.png", iconSource = IconSource.ARASAAC),
        ...
        starter("back", "HRBET", "Boli me hrbet.", "pain.back", "PAIN", "pain", listOf("hrbet", "bolečina"), placements = pageFour(9), opensSubicons = true, children = painBackDetailChildren(), questionByLanguage = mapOf("sl" to "Kje boli?"), imagePath = "custom/pain/back.jpg", iconSource = IconSource.CUSTOM),
        starter("belly", "TREBUH", "Boli me trebuh.", "pain.belly", "PAIN", "pain", listOf("trebuh", "bolečina"), placements = pageFour(10), opensSubicons = true, children = painBellyDetailChildren(), questionByLanguage = mapOf("sl" to "Kje boli?"), imagePath = "custom/pain/belly.jpg", iconSource = IconSource.CUSTOM),
