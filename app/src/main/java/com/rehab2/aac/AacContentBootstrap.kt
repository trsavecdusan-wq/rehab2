...
object AacContentBootstrap {
    ...
    private val PROFESSIONAL_SYSTEM_ICON_BY_STARTER_ID = mapOf(
        ...
        "sparkling_drink" to "system/drink_soda.png",
        "milk_drinks" to "system/drink_milk.png",
        "drink_fanta" to "system/drink_fanta.png",
        "drink_coca_cola" to "system/drink_cola.png",
        ...
        "potato" to "system/food_potatoes.png",
        "rice" to "system/food_rice.png",
        "ice_cream" to "system/snack_ice_cream.png",
        "food_yogurt" to "system/food_yogurt.png",
        "food_banana" to "system/snack_banana.png",
        "food_apple" to "system/snack_apple.png",
        "food_lunch" to "system/food_lunch.png",
        "food_dinner" to "system/food_dinner.png",
        ...
        "hungry_potato" to "system/food_potatoes.png",
        "hungry_chicken" to "system/meal_chicken.png",
        ...
        "hungry_apple" to "system/snack_apple.png",
        "hungry_banana" to "system/snack_banana.png",
        "hungry_ice_cream" to "system/snack_ice_cream.png",
        "hungry_cake" to "system/snack_cake.png",
        "hungry_cookies" to "system/snack_cookies.png",
        "hungry_pizza" to "system/snack_pizza.png",
