...
object AacContentBootstrap {
    ...
    private const val KEY_CORE_V2_HOME_REPAIR_DONE = "aac_first_patient_page_review_v2_done"
    private const val KEY_AAC_HOME_LAYOUT_VERSION = "aac_home_layout_version"
    private const val CORE_V2_HOME_LAYOUT_VERSION = "first_patient_page_review_v2"
    ...
    private val PROFESSIONAL_SYSTEM_ICON_BY_STARTER_ID = mapOf(
        ...
        "turn_me" to "system/care_turn_bed.png",
        "body_position" to "system/care_turn_bed.png",
        "change_position" to "system/care_transfer.png",
